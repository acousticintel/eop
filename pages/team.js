...
const partners = [
  {
    ...
    desc: "Enos has worked as a creative director on major TV shows/projects for Kenya’s top TV networks (live and pre-packaged), and TVC productions ( with some of Kenya’s leading brands), Feature Films (Supa Modo) and is also one of the region’s top music video director. He has worked with top artists across the continent and has directed some of Kenya’s top and classic music videos.",
  },
  {
  ...
  return (
    ...
    >
      <motion.div variants={pageHeadContAni} className="w-full">
        ...
        <motion.h4
          variants={pageHeadAni}
          className="text-5xl text-blue-700 font-bold mt-4"
        >
          Meet the team
        </motion.h4>
        <motion.p
